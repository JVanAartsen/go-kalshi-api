...
The code param on the path should be filled with the verification code sent by email.
	...
	@return ApiResetPasswordConfirmRequest
	*/
	ResetPasswordConfirm(ctx context.Context, code string) ApiResetPasswordConfirmRequest

	// ResetPasswordConfirmExecute executes the request
	ResetPasswordConfirmExecute(r ApiResetPasswordConfirmRequest) (*http.Response, error)
}
...
func (a *AuthApiService) LoginExecute(r ApiLoginRequest) (*LoginResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/log_in"
...
func (a *AuthApiService) LogoutExecute(r ApiLogoutRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/log_out"
...
func (a *AuthApiService) ResetPasswordExecute(r ApiResetPasswordRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/passwords/reset"
...
type ApiResetPasswordConfirmRequest struct {
	ctx context.Context
	ApiService AuthApi
	code string
...
// Data required to finish a password reset.
func (r ApiResetPasswordConfirmRequest) ConfirmPasswordResetRequest(confirmPasswordResetRequest ConfirmPasswordResetRequest) ApiResetPasswordConfirmRequest {
	r.confirmPasswordResetRequest = &confirmPasswordResetRequest
	return r
}

func (r ApiResetPasswordConfirmRequest) Execute() (*http.Response, error) {
	return r.ApiService.ResetPasswordConfirmExecute(r)
}
...
The code param on the path should be filled with the verification code sent by email.
 ...
 @return ApiResetPasswordConfirmRequest
*/
func (a *AuthApiService) ResetPasswordConfirm(ctx context.Context, code string) ApiResetPasswordConfirmRequest {
	return ApiResetPasswordConfirmRequest{
		ApiService: a,
		ctx: ctx,
		code: code,
...
// Execute executes the request
func (a *AuthApiService) ResetPasswordConfirmExecute(r ApiResetPasswordConfirmRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthApiService.ResetPasswordConfirm")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/passwords/reset/{code}/confirm"
	...
	// body params
	localVarPostBody = r.confirmPasswordResetRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
